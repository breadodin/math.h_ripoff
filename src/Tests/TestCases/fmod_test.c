...
START_TEST(s21_fmod_test21) {
  ck_assert_double_eq(s21_fmod(-1, -1), fmod(-1, -1));
}
END_TEST

START_TEST(s21_fmod_test22) {
  ck_assert_double_eq(s21_fmod(-1, -2), fmod(-1, -2));
}
END_TEST

START_TEST(s21_fmod_test23) { ck_assert_double_eq(s21_fmod(2, 3), fmod(2, 3)); }
END_TEST
