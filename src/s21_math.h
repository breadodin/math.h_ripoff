...
long double s21_tan(double x);  //  тангенс DONE  (на основе синуса баги те же)

long double s21_asin(double x);  //  арксинус DONE
long double s21_acos(double x);  //  арккосинус DONE (работает через asin)
long double s21_atan(double x);  //  арктангенс DONE
long double s21_atan_addon(double x);  //  осоновной подсчет atan
...
long double s21_fmod(double x, double y);  //  остаток деления с плавающей точкой DONE (если делить два отрицательных числа без остатка, то результат не соответсвует ожидаемому:
                                                                                                                                        // math.h = -0.000000 s21_.h = 0.000000)
